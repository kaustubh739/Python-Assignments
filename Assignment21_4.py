# Design automation script which accepts directory name and mail id from user and create log file in that directory which contains information
# of running processes as it's name,pid,username. after creating log file send that log file to the specified email.
